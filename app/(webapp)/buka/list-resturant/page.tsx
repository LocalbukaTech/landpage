          ...
          <div className='space-y-6 animate-in fade-in slide-in-from-right-4 duration-300'>
            ...
            <div className='bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 space-y-5'>
              ...
              <div className='grid grid-cols-2 sm:grid-cols-4 gap-3'>
                {PRICE_LEVELS.map((pl) => (
                  <button
                    key={pl.value}
                    onClick={() => set('priceLevel', pl.value)}
            ...
            <div className='bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6'>
              <div className='flex items-center justify-between'>
                ...
                <button
                  onClick={() =>
                    set('isClaimedByOwner', !form.isClaimedByOwner)
                  }
          ...
          <div className='space-y-6 animate-in fade-in slide-in-from-right-4 duration-300'>
            ...
            <div className='bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 space-y-5'>
              <div className='flex items-center gap-3 mb-2'>
                ...
                <div>
                  ...
                  <p className='text-sm text-zinc-400'>
                    Upload up to 10 photos of your restaurant
                  </p>
                </div>
              </div>
              ...
              <div className='space-y-3'>
                {DAYS.map((day) => (
                  <div key={day} className='flex items-center gap-4'>
                    <span className='w-24 text-sm font-semibold text-zinc-300 capitalize'>
                      {day}
                    </span>
                    <input
                      type='text'
            ...
            <div className='bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 space-y-4'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm'>
                ...
                <div className='space-y-1'>
                  ...
                  <p className='text-white font-medium'>
                    {
                      PRICE_LEVELS.find((p) => p.value === form.priceLevel)
                        ?.label
                    }{' '}
                    —{' '}
                    {
              ...
              <div className='pt-3 border-t border-white/5'>
                <div className='flex items-start gap-3 text-xs text-zinc-500'>
                  ...
                  <p>
                    By submitting, you agree that your listing may appear
                    publicly on LocalBuka. It will be reviewed by our team
            ...
            <button
              ...
              {createMutation.isPending ? (
                ...
                <>
                  Submit Restaurant <Check size={18} />
                </>
              )}
            </button>
          </div>
        ...
        {step === 4 && (
          <div className='flex flex-col items-center justify-center text-center py-16 animate-in fade-in zoom-in-95 duration-500'>
            <div className='relative w-48 h-48 mb-10 flex items-center justify-center'>
              <div
                className='absolute inset-0 rounded-full bg-[#fbbe15]/5 animate-ping'
            ...
            <div className='flex flex-col sm:flex-row gap-3 w-full max-w-sm'>
              <button
                onClick={() => router.push('/buka/my-restaurant')}
                className='flex-1 py-3.5 bg-[#fbbe15] text-[#1a1a1a] font-bold rounded-xl hover:bg-[#e5ac10] transition-all'>
                My Restaurants
              </button>
              <button
                onClick={() => router.push('/buka')}
                className='flex-1 py-3.5 bg-white/5 border border-white/10 text-white font-bold rounded-xl hover:bg-white/10 transition-all'>
                Explore Buka
              </button>
            </div>
          </div>
