...
const siteConfig = {
  name: 'LocalBuka',
  description:
    'Find the best restaurants - from hidden gems to local favorites - in any city. Discover authentic Nigerian cuisine, local food spots, and culinary experiences near you.',
