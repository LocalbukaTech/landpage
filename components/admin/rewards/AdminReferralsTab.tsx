...
export function AdminReferralsTab({ onViewDetail }: AdminReferralsTabProps) {
  ...
  const getStatusBadge = (referralStatus: string) => {
    switch (referralStatus) {
      case "COMPLETED":
        return (
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl text-[11px] font-bold bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-700">
      ...
      default:
        return (
          <span className="inline-flex items-center px-2.5 py-1 rounded-xl text-[11px] font-bold bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700">
            {referralStatus}
          </span>
        );
    }
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-xs overflow-hidden">
                  ...
                  >
                    ...
                    <td className="py-3.5 px-4 font-mono text-[11px] text-gray-500">
                      <div
                        ...
                        title={item.refereeDeviceId || ""}
                      >
                        {item.refereeDeviceId
                          ? item.refereeDeviceId.slice(0, 10) + "..."
        ...
        <div className="px-5 py-3.5 bg-gray-50 dark:bg-gray-800/40 border-t border-gray-200 dark:border-gray-800 flex items-center justify-between text-xs text-gray-500">
          <span>
            Showing <strong>{referrals.length}</strong> of{" "}
