        ...
        <button
          ...
          {Array.from({length: 5}).map((_, i) => (
            <Star
              ...
              size={14}
              className={
                i < stars ? 'text-[#fbbe15] fill-[#fbbe15]' : 'text-zinc-600'
              }
            />
          ))}
        </button>
...
function PriceRangeSlider({
  ...
  const valFromEvent = (clientX: number) => {
  ...
  return (
    <div
      ...
      <div
        ref={trackRef}
        className='absolute left-0 right-0 h-1.5 rounded-full bg-zinc-700'
      />
      {/* Active range */}
      <div
...
export function CuisineFilters({
  ...
  return (
    <div className='flex flex-col gap-6 w-full'>
      ...
      <div className='flex flex-col gap-3'>
        ...
        <div className='flex gap-2'>
          <div className='flex-1'>
            <label className='text-zinc-400 text-[10px] mb-1 block'>
              Min. Price (₦)
            </label>
            <input
              type='text'
      ...
      {/* ── Food Quality ── */}
      <div className='flex flex-col gap-3'>
        <span className='text-[#fbbe15] text-xs font-semibold'>
          Food Quality
        </span>
        <StarRating
