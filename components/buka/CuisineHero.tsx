...
export function CuisineHero({name, description, images}: CuisineHeroProps) {
  ...
  return (
    <section className='relative w-full h-[50vh] md:h-[800px] overflow-hidden rounded-b-2xl'>
      {/* Images */}
      {images.map((img, i) => (
        <div
          key={i}
      ...
      {/* Content */}
      <div className='absolute bottom-8 left-4 right-4 md:bottom-12 md:left-8 md:right-auto z-10 flex flex-col gap-3 md:max-w-md'>
        <h1 className='text-white text-xl md:text-[28px] font-bold leading-tight'>
          {name}
        </h1>
